...
const Imagefilm = ({ pageData, globalData, preview, lang }) => {
  const bodyTextData = pageData?.bodyText || []

  return (
    <>
      <main id="main-content" className="main page--imagefilm content" data-readable="true" role="main">
