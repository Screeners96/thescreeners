  ...
  try {
    ...
    if (event) {
      allPages.push({
        ...
        bodyText: {
          en: typeof event.bodyText?.en === 'string' 
            ? event.bodyText.en 
            : portableTextToPlainText(event.bodyText?.en),
          de: typeof event.bodyText?.de === 'string' 
            ? event.bodyText.de 
            : portableTextToPlainText(event.bodyText?.de)
        }
      })
    ...
    if (trailer) {
      allPages.push({
        ...
        bodyText: {
          en: typeof trailer.bodyText?.en === 'string' 
            ? trailer.bodyText.en 
            : portableTextToPlainText(trailer.bodyText?.en),
          de: typeof trailer.bodyText?.de === 'string' 
            ? trailer.bodyText.de 
            : portableTextToPlainText(trailer.bodyText?.de)
        }
      })
    ...
    if (imagefilm) {
      allPages.push({
        ...
        bodyText: {
          en: typeof imagefilm.bodyText?.en === 'string' 
            ? imagefilm.bodyText.en 
            : portableTextToPlainText(imagefilm.bodyText?.en),
          de: typeof imagefilm.bodyText?.de === 'string' 
            ? imagefilm.bodyText.de 
            : portableTextToPlainText(imagefilm.bodyText?.de)
        }
      })
